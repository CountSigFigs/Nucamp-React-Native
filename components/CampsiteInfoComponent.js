...
import {Text, View, ScrollView, Share, FlatList, Modal, Button, StyleSheet, Alert, PanResponder} from 'react-native';
...
function RenderCampsite(props){
    ...
    const recoginizeDrag = ({dx}) => (dx < -200) ? true: false
    const recoginizeComment = ({dx}) => (dx > 200) ? true: false
    ...
    const panResponder = PanResponder.create({
        ...
        onPanResponderEnd: (e, gestureState) => {
            ...
            if (recoginizeDrag(gestureState)){
                Alert.alert(
                    'Add Favorite',
            ...
            if (recoginizeComment(gestureState)){
                props.onShowModal()
            }
            return true;
        }
